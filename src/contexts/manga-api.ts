...
// 上传浏览记录
export const UPCOMICREINFO = `https://interface.dmzj.com/api/record/getRe?callback=record_jsonpCallback&uid={uid}&type=3&st=comic&json=[{"time" : "{time}","chapterId": "{cid}","{oid}": "{cid}","comicId": {oid},"page": {page}}]&${suffix}`
